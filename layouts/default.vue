<template>
  <header >
    <nav class="bg-white border-gray-200 dark:bg-gray-900">
      ...
      >
        <a href="https://flowbite.com/" class="text-xl font-bold">
          Backend Training
        </a>
        <div class="flex items-center md:order-2">
          ...
          <!-- Dropdown menu -->
          <div
            class="z-50 hidden my-4 md:!-ml-5 text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-700 dark:divide-gray-600"
            id="user-dropdown"
          >
            <div class="px-4 py-3">
